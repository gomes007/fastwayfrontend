...
function Employee01() {
    ...
    const saveEmployee = () => {
        ...
        EmployeeService.saveEmployee(data, employee.file)
            .then(response => {
                console.log("Employee01 saved successfully." + response.data);
            })
            .catch(error => {
                ...
                tabs={[
                    {
                        ...
                        content: (
                            <EmployeePersonalDataForm
                                employee={employee}
                                handleEmployeeChange={handleEmployee}
                                handleFileChange={setEmployee}
                            />
                        )
                    },
                    {
